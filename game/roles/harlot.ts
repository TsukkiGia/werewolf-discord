...
export const HarlotRole: RoleDefinition = {
  ...
  description:
    ...
    'Fatal outcomes: visiting a wolf pack member (werewolf/wolf_cub/alpha_wolf) or the Serial Killer, ' +
    'or visiting the player the wolves or the Serial Killer chose to kill (even if the doctor saved that player). ' +
  ...
  buildRoleIntro: ({ assignment }: RoleIntroContext): string =>
    ...
    '- If you visit a wolf or the Serial Killer, you will be killed.\n' +
    '- If you visit the player the wolves or the Serial Killer chose to kill, you will be killed.\n' +
